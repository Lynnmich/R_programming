...
#You can view variable names using the name function name()
names(students)
...
read.csv("C:/Users/michuk_lyn/Documents/R_Programming/GSSsubset.csv")
#Example (change pathway to your working directory)
gss <- read.csv("C:/Users/michuk_lyn/Documents/R_Programming/GSSsubset.csv")
...
# note the / instead of \ on MS Windows systems
 ...
 GssSubset_data <- read.table("C:/Users/michuk_lyn/Documents/R_Programming/GSSsubset.csv", header=TRUE, sep=",", row.names="id")
...
#Sleep data
#This is real data file condensed from a study conducted to explore the prevalence and impact of 
#sleep problems on various aspects of people's lives. Staff from a university in Melbourne, Australia 
#were invited to complete a questionnaire containing questions about their sleep behaviour (e.g. hours 
#slept per night), sleep problems (e.g. difficulty getting to sleep) and the impact that these problems 
#have on aspects of their lives (work, driving, relationships). The sample consisted of 271 respondents
#(55% female, 45% male) ranging in age from 18 to 84 years (mean=44yrs).
