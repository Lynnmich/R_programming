...
#setwd("C://Users//user//Documents//R practicals")
######Initiate packages
getwd()
...
# The correlation coefficient squared (known as the coefficient of determination, R²) is a measure of the amount of 
# variability in one variable that is shared by the other. You can interpret the R² as the proportion of variation in the dependent variable that is predicted by the independent variable(s). It's value ranges from 0 to 1 and can be calculated by simply squaring R values
